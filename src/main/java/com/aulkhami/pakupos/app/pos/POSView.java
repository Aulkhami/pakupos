...
public class POSView implements View {
    ...
    public void setModel(Model model) {
        ...
        this.model.getCart().addListener((ListChangeListener<Product>) change -> updateCartSummary());

        // Listen to catalog changes to render
        this.model.getCatalog().addListener((ListChangeListener<Product>) change -> renderProducts());
    ...
    private void renderProducts() {
        ...
        for (Product p : model.getCatalog()) {
